import React, { forwardRef, MutableRefObject, RefAttributes, useCallback, useImperativeHandle, useRef } from 'react';
...
const CastMemberField =
  ...
  const fetchCastMembers = useCallback((searchText: string) => {
